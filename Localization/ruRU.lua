...
L["Tab5AuraAlerts"] = "Оповещения аур" -- ИИ перевод

-- ╭────────────────────────────────────────────────────────────────────────────────╮
-- │                         Options Panel - Aura Alerts Tab                        │
-- ╰────────────────────────────────────────────────────────────────────────────────╯
L["AuraAlertsHeader"]    = Colors.iSP .. "Оповещения аур" -- ИИ перевод
L["AuraAlertsInfo"]      = "Воспроизводить звук при получении или потере баффа/дебаффа.\nВведите точное название ауры, как оно отображается во всплывающей подсказке." -- ИИ перевод
L["AuraNamePlaceholder"] = "Название ауры (напр. Гипертермия)" -- ИИ перевод
L["AuraAlertGained"]     = "Получена" -- ИИ перевод
L["AuraAlertLost"]       = "Потеряна" -- ИИ перевод
L["AuraAlertBoth"]       = "Обе" -- ИИ перевод
L["AuraTypeBuff"]        = "Бафф" -- ИИ перевод
L["AuraTypeDebuff"]      = "Дебафф" -- ИИ перевод
L["AuraTypeAny"]         = "Любой" -- ИИ перевод
L["AuraAlertTriggerOn"]  = "Условие:" -- ИИ перевод
L["AuraAlertType"]       = "Тип:" -- ИИ перевод
L["AuraAlreadyTracked"]  = Msg(Colors.Yellow .. "%s уже отслеживается." .. Colors.Reset) -- ИИ перевод
L["AuraGained"]          = Msg("%s получена!") -- ИИ перевод
L["AuraLost"]            = Msg("%s потеряна!") -- ИИ перевод
L["AuraRetailCombatNote"] = "Retail 12.0 ограничивает данные аур в бою. Оповещения используют кэшированные данные заклинаний — ауры, замеченные до боя, отслеживаются надёжно. Новые проки могут обнаруживаться с небольшой задержкой." -- ИИ перевод
L["RetailCombatNote"] = "Примечание: Retail 12.0 (Midnight) ограничивает доступ аддонов к боевым данным. Эта функция может работать ненадёжно во время боя на ретейле." -- ИИ перевод
L["CooldownDuration"] = "Длительность (сек):" -- ИИ перевод
L["CooldownDurationHint"] = "Используется в бою, когда данные заклинаний ограничены" -- ИИ перевод
...
L["DefaultWoWSounds"] = Colors.iSP .. "Стандартные звуки WoW" -- ИИ перевод
L["AddDefaultSounds"] = "Добавить звуки WoW" -- ИИ перевод
L["DefaultSoundsDesc"] = Colors.Gray .. "Добавляет встроенные звуки WoW (предупреждение рейда, проверка готовности, повышение уровня и т.д.) в ваш список. Используются звуки самой игры, файлы не требуются." .. Colors.Reset -- ИИ перевод
L["DefaultSoundsAdded"] = "%d стандартных звуков добавлено в ваш список." -- ИИ перевод
L["DefaultSoundsExist"] = "Все стандартные звуки уже в вашем списке." -- ИИ перевод
